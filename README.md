...
There is a tutorial for this quickstart in the [Getting Started Developing Applications Guide](http://www.jboss.org/jdf/quickstarts/jboss-as-quickstart/guide/siscompras/).
...
4. This will deploy `target/siscompras.war` to the running instance of the server.
